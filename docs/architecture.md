...
graph TB
    ...
    subgraph AWS["☁️ AWS (eu-central-1)"]
        ...
        subgraph Lambda["Lambda Functions (Python 3.11, arm64)"]
            UH["upload_handler"]
        ...
        subgraph Storage["Storage"]
            ...
            S3I["S3: Images<br/>(Workbook Scans)"]
        end
...
| **Datenbank** | DynamoDB (7 Tabellen, On-Demand Billing) |
