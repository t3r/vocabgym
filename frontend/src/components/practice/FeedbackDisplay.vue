<template>
  <div
    ...
    :class="correct ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'"
  >
    <div class="flex items-center justify-center gap-2 mb-2">
      ...
      <span class="font-semibold" :class="correct ? 'text-green-800' : 'text-red-800'">
    ...
    <div v-if="!correct" class="mt-2">
      <p class="text-sm text-gray-600">
        Deine Antwort: <span class="font-medium text-red-700">{{ userAnswer }}</span>
      </p>
      <p class="text-sm text-gray-600 mt-1">
        Richtige Antwort: <span class="font-medium text-green-700">{{ correctAnswer }}</span>
      </p>
